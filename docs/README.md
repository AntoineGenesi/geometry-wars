...
| `DEV_CUSTOM_MESHES.md` | Developer guide for custom mesh loading |
| `ISSUES-AND-SOLUTIONS.md` | Known issues and their solutions |

## Development Guides

| File | Purpose |
|------|---------|
| `HUMAN_TEST.md` | Manual test checklist — check here after fixes |
...
See `.claude/docs/` for AI-focused technical documentation:
