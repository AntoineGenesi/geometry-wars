...
/** All 50 presets (16 standard + 14 Sektori Dark + 4 Sektori Light + 8 experimental + 4 Desktop Defender + 8 CRT/creative) */
export const VISUAL_PRESETS: VisualPreset[] = [
  ...
  // -- CRT & Creative presets (rows 13-14) ---
  {
    ...
    gridSegmentsV: 64,
    depthCurve: 'moderate',
    description: 'Green phosphor CRT. Dense horizontal scanlines, warm glow.',
    sektoriConfig: {
      baseColor: new THREE.Color(0x001a08),
      glowColor: new THREE.Color(0x33ff66),
      glowColor2: new THREE.Color(0x22cc44),
      glowRadius: 5.0,
      falloffExponent: 1.8,
      baseOpacity: 0.12,
      glowOpacity: 0.9,
