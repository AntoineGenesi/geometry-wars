...
/** Built-in presets: standard, Sektori, light/tactical, CRT, and creative variants. */
export const VISUAL_PRESETS: VisualPreset[] = [
  {
    name: 'Classic Neon',
    gridColor: 0x284b7a,
    surfaceColor: 0x080d22,
    surfaceOpacity: 0.28,
    gridOpacity: 0.34,
    wireframeOnly: false,
    bloomStrength: 0.62,
    ...
    gridSegmentsV: 18,
    depthCurve: 'steep',
    description: 'Readable dark arcade style with restrained grid glow.',
  },
  {
    name: 'Ghost Wire',
    gridColor: 0x00ffff,
  ...
  // -- Desktop Defender presets (light background, minimal bloom) --
  {
    ...
    gridSegmentsV: 30,
    depthCurve: 'gentle',
    description: 'High-contrast tactical map: charcoal grid on muted field.',
  },
  {
    name: 'Vector Blueprint',
    gridColor: 0x0c3d5d,
    surfaceColor: 0xbfd9e4,
    surfaceOpacity: 0.68,
    gridOpacity: 0.7,
    wireframeOnly: false,
    bloomStrength: 0.22,
    ...
    gridSegmentsV: 26,
    depthCurve: 'gentle',
    description: 'Technical cyan-blue plan with dark readable grid lines.',
  },
  {
    name: 'Drafting Table',
    gridColor: 0x3f3b36,
    surfaceColor: 0xf1efe5,
    surfaceOpacity: 0.66,
    gridOpacity: 0.62,
    wireframeOnly: true,
    bloomStrength: 0.08,
    ...
    gridSegmentsV: 18,
    depthCurve: 'moderate',
    description: 'Clean drafting-paper wireframe with almost no glow.',
  },
  {
    name: 'Command Plot',
    gridColor: 0x1e6d54,
    surfaceColor: 0xe8e5d2,
    surfaceOpacity: 0.7,
    gridOpacity: 0.68,
    wireframeOnly: false,
    bloomStrength: 0.16,
    ...
    gridSegmentsV: 32,
    depthCurve: 'gentle',
    description: 'Warm command-map palette with strong green contour lines.',
  },

  // -- CRT & Creative presets (rows 13-14) ---
  {
    name: 'CRT Phosphor',
    gridColor: 0x2ecf69,
    surfaceColor: 0x020b04,
    surfaceOpacity: 0.24,
    gridOpacity: 0.58,
    wireframeOnly: false,
    bloomStrength: 1.05,
    ...
    gridSegmentsV: 72,
    depthCurve: 'moderate',
    description: 'Green phosphor vector display with dense scanline rhythm.',
    sektoriConfig: {
      baseColor: new THREE.Color(0x001205),
      glowColor: new THREE.Color(0x55ff88),
      glowColor2: new THREE.Color(0xffbb44),
      glowRadius: 5.0,
      falloffExponent: 1.8,
      baseOpacity: 0.12,
      glowOpacity: 0.9,
  ...
  {
    name: 'CRT Cold Phosphor',
    gridColor: 0xaaccff,
    surfaceColor: 0x040818,
    surfaceOpacity: 0.25,
    gridOpacity: 0.8,
    wireframeOnly: false,
    bloomStrength: 1.2,
    ...
    gridSegmentsV: 56,
    depthCurve: 'steep',
    description: 'Blue-white phosphor CRT. Cool tones, tight horizontal lines.',
    sektoriConfig: {
      baseColor: new THREE.Color(0x020410),
      glowColor: new THREE.Color(0xaaccff),
      glowColor2: new THREE.Color(0x6688cc),
      glowRadius: 4.0,
      falloffExponent: 2.2,
      baseOpacity: 0.10,
      glowOpacity: 0.85,
  ...
  },
  {
    ...
    gridSegmentsV: 72,
    depthCurve: 'moderate',
    description: 'Amber monochrome terminal. Dense scanlines, warm phosphor burn.',
    sektoriConfig: {
      baseColor: new THREE.Color(0x0a0400),
      glowColor: new THREE.Color(0xffaa33),
      glowColor2: new THREE.Color(0xcc7700),
      glowRadius: 4.5,
      falloffExponent: 2.0,
      baseOpacity: 0.15,
      glowOpacity: 0.92,
  ...
  },
  {
    ...
    gridSegmentsV: 15,
    depthCurve: 'extreme',
    description: 'Deep void. Blinding white-blue bloom devours grid lines. Event horizon.',
    sektoriConfig: {
      baseColor: new THREE.Color(0x000002),
  ...
  },
  {
    ...
    gridSegmentsV: 20,
    depthCurve: 'moderate',
    description: 'FLIR heat map. Red-orange core fading to dark. Thermal vision.',
    sektoriConfig: {
      baseColor: new THREE.Color(0x0a0008),
      glowColor: new THREE.Color(0xff2200),
      glowColor2: new THREE.Color(0xffcc00),
      glowRadius: 5.5,
      falloffExponent: 1.6,
      baseOpacity: 0.06,
      glowOpacity: 0.95,
      ...
      trailCount: 8,
      trailFalloff: 0.65,
      trailRadiusFalloff: 0.82,
    },
  },
  {
    name: 'Limelight',
    gridColor: 0x44ff44,
    surfaceColor: 0x000800,
    surfaceOpacity: 0.08,
    gridOpacity: 1.0,
    wireframeOnly: true,
    bloomStrength: 1.6,
    ...
    gridSegmentsV: 28,
    depthCurve: 'steep',
    description: 'Bright green wireframe on black void. Hacker terminal meets Tron.',
  },
  {
    name: 'Midnight Chrome',
    gridColor: 0x8899bb,
    surfaceColor: 0x060810,
    surfaceOpacity: 0.45,
    gridOpacity: 0.55,
    wireframeOnly: false,
    bloomStrength: 0.7,
    ...
    gridSegmentsV: 24,
    depthCurve: 'steep',
    description: 'Dark metallic blues and silvers. Subtle cold reflections.',
    sektoriConfig: {
      baseColor: new THREE.Color(0x040608),
      glowColor: new THREE.Color(0x99aacc),
      glowColor2: new THREE.Color(0x556688),
      glowRadius: 3.5,
      falloffExponent: 2.5,
      baseOpacity: 0.15,
      glowOpacity: 0.7,
  ...
  },
  {
    ...
    gridSegmentsV: 18,
    depthCurve: 'moderate',
    description: 'Psychedelic neon. Maximum saturation, heavy bloom, sensory overload.',
    sektoriConfig: {
      baseColor: new THREE.Color(0x0a0018),
      glowColor: new THREE.Color(0xff00ff),
      glowColor2: new THREE.Color(0x00ffff),
      glowRadius: 6.0,
      falloffExponent: 1.4,
      baseOpacity: 0.08,
      glowOpacity: 1.0,
